...
export default function MarqueeStrip() {
  ...
  return (
    <div className="relative py-5 border-y border-white/[0.04] overflow-hidden bg-[#050816]/80">
      <div className="flex animate-marquee whitespace-nowrap gap-0">
        {doubled.map((item, i) => (
          <span key={i} className="inline-flex items-center gap-3 px-5 text-xs sm:text-sm text-white/55 uppercase tracking-[0.15em] shrink-0">
