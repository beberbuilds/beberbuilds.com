        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button
                variant="outline"
                className="rounded-xl px-6 sm:px-7 py-6 sm:py-6 text-[15px] sm:text-sm font-medium border-white/10 text-white hover:bg-white/5 hover:border-[#7C3AED]/30 transition-all duration-300 group w-full sm:w-auto tap-area"
              >
                <MessageCircle className="w-4 h-4 mr-2 group-hover:text-[#A78BFA] transition-colors" />
                Chat on WhatsApp
              </Button>
            </div>
          </div>
